...
from models.manifest import Manifest, ManifestComparison
from models.file_entry import FileEntry, FileEdited

def file_hash(file_path: str, algorithm: Algorithm) -> str:
    """
...
def create_manifest(directory_path: str, algorithm: Algorithm) -> Manifest:
    """
    ...
    for file_path in files:
        ...
        digest = file_hash(file_path, algorithm)
    ...
    manifest.directory_hash = manifest_hash(manifest, algorithm)
